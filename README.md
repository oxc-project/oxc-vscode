...
| `oxc.path.oxfmt`            | -             | `<string>`                       | Path to an Oxc formatter binary. Default: auto detection in `node_modules`. Supports `${userHome}` and `${env:NAME}`. An unset or empty environment variable is replaced by an empty string; a value which is empty after this replacement uses the auto detection.                |
| `oxc.path.oxlint`           | -             | `<string>`                       | Path to an Oxc linter binary. Default: auto detection in `node_modules`. Supports `${userHome}` and `${env:NAME}`. An unset or empty environment variable is replaced by an empty string; a value which is empty after this replacement uses the auto detection.                   |
...
| Deprecated                  |               |                                  |                                                                                                                                                                                                                                                                                    |
| `oxc.path.server`           | -             | `<string>`                       | Path to Oxc language server binary. Mostly for testing the language server. Supports `${userHome}` and `${env:NAME}`. An unset or empty environment variable is replaced by an empty string; a value which is empty after this replacement uses the auto detection.                |
