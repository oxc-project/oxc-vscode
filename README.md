...
| `oxc.lint.customization`      | `{}`          | `Record<string, string>`                                                                                      | Customizes linting rules behavior. See https://oxc.rs/docs/guide/usage/linter/lsp-config-reference.html#rulescustomization for details.                                                                                                |
